...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return buildMetadata({
    ...
    description: `${service.longDescription} Call or text ${business.phoneDisplay} to get started.`,
  ...
  return (
    <>
      ...
      <section className="mx-auto max-w-3xl px-4 py-10 md:px-6 md:py-14">
        <span className="inline-flex h-12 w-12 items-center justify-center border-2 border-(--color-ink) bg-(--color-paper-alt) text-(--color-accent)">
